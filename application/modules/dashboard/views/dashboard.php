                    ...
                    <div class="modal-dialog">
                      ...
                      <div class="modal-content" style="width: 128%;">
                        ...
                        <div class="">
                              ...
                              <div class="form-group">
                                <label class="col-md-2 control-label" for="linkid">Link</label>  
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-md-7" id="exp">
                                  <textarea id="explanation_answer" class="form-control" rows="3" maxlength="350" name="exp_answer" onKeyDown="limitText(this,350);" onKeyUp="limitText(this,350);"></textarea>
                                <p style="font-size: 11px;">Max 350 characters allowed</p>    
                                <div id="login_credits_err" class="error"></div>
                                </div>
                              </div>
                           ...
                           <div class="modal-content">
                               ...
                               <div class="modal-body">
                                  ...
                                  <form id="edit_form" enctype="multipart/form-data" accept-charset="utf-8" name="fileinfo">
                                       ...
                                       <input type="hidden" name="edit_news_category" id="edit_news_category" class="form-control">
                                       ...
                                       <hr>
                                       <p>Tags: </p>
                                       <input type="text" class="form-control" name="edit_news_tags" id="edit_news_tags" placeholder="News Tag">
                           ...
                           <div class="modal-content">
                               ...
                               <div class="modal-body">
                                  ...
                                  <form enctype="multipart/form-data" accept-charset="utf-8" name="copyInfo">
                                      <input type="hidden" name="copy_news_id" id="copy_news_id">
                                      <input type="hidden" name="copy_news_category" id="copy_news_category">
