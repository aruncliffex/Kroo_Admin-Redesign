                      ...
                      <div class="modal-content" style="width: 128%;">
                        ...
                        <div class="">
                              ...
                              <div class="form-group">
                                <label class="col-md-2 control-label" for="user_email">Link</label>  
                                <div class="col-md-6">
                                  <input id="linkidView" name="link" placeholder="Link" class="form-control input-md" type="text" value="">
                                <div id="login_credits_err" class="error"></div>
                                </div>
                              </div>
                              ...
                              <div class="form-group">
                                <label class="col-md-2 control-label" for="tagid">Tags</label>  
                                <div class="col-md-6" id="tags">
                                  <input id="tagidView" name="tags" placeholder="Tags" class="form-control input-md" type="text" value="">
                                </div>
                              </div>
                              ...
                              <div class="form-group">
                                <label class="col-md-2 control-label" for="user_email">Explaination</label>  
                                <div class="col-md-7">
                                  <textarea id="explanation_answerView" class="form-control" rows="3" maxlength="500" name="exp_answer"></textarea> 
                                <div id="login_credits_err" class="error"></div>
                                </div>
                              </div>
