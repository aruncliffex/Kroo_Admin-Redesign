    ...
    foreach($kroo_news as $news){ 
            ...
            if($news['rss_sports_news_id'] && $news['sports_is_deleted'] == 0){
                ...
                echo '<td class="text-center">';
                    echo '<button data-id="'.$news['rss_sports_id'].'" id="btn_edit_'.$news['rss_sports_id'].'" data-team_id="'.$news['league_team_id'].'" data-league_id="'.$news['rss_league_id'].'" data-toggle="tooltip" data-placement="top" title="Edit" type="button" class="btn btn-default btn-sm btn_edit_news">  <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></button>';
