...
class Dashboard extends Controller {
    ...
    public function update_news(){ 
        ...
        if($tab_index == 0 || $tab_index == 1 || $tab_index == 4){
            $responce = $this->dashboard_model->update_news($news_id,$news_title,$news_summary,$news_url,$edited_by_id,$team_id,$news_source,$tab_index);    
        }else if($tab_index == 2){
            $responce = $this->dashboard_model->update_player_news($news_id,$news_title,$news_summary,$news_url,$edited_by_id);
        }else{
            $responce = $this->dashboard_model->update_waiver_news($news_id,$news_title,$news_summary,$news_url,$edited_by_id);
        }
    ...
    if($result != 'update'){
        foreach($result as $val){ 
            ...
            $result = $this->dashboard_model->insert_published_news($news_data,$news_id,$team_id,$tab_index,$league_id);     	
        }            
    }
    ...
    public function newspublishedfantasy($fnews_id,$tab_index){               
        $user_id = $this->session->userdata('id');
        $this->dashboard_model->news_publish_activity($fnews_id, $tab_index, $user_id);
        $result = $this->dashboard_model->newspublishedfantasy($fnews_id,$user_id);
        if($result != 'update'){
            foreach($result as $val){
                $league_id = $val['league_id'];                
                $news_data = array(
                        'rss_player_news_id'    => $val['id'],
                        'title'                 => $val['title'],
                        'channel_published_at' => $val['channel_published_at'],
                        'summary'       => $val['summary'],
                        'details' => $val['details'],
                ...
                $result = $this->dashboard_model->insert_publishedArticle_news($news_data, $tab_index,$league_id); 
            }
    ...
    public function newspublishedarticle($fnews_id, $tab_index){
        $user_id = $this->session->userdata('id');
        $this->dashboard_model->news_publish_activity($fnews_id, $tab_index, $user_id);            
        $result = $this->dashboard_model->newspublishedarticle($fnews_id,$user_id);
        if($result != 'update'){
            foreach($result as $val){    
                $league_id = $val['league_id'];           
                $news_data = array(                        
                        'rss_waiver_news_id'    => $val['id'],
                        'title'                 => $val['title'],
                        'summary'       => $val['summary'],
                        'details' => $val['details'],
                        'image' => $val['image'],
    ...
    public function copy_news(){
        ...
        $result = $this->dashboard_model->copy_news($news_id,$team_id,$tab_index);
   ...
   public function check_team($news_id, $tab_index){
    ...
    public function push_content($news_id, $tab_index=0,$level){	
        ...
        $publish = $this->dashboard_model->newsPublishNotified($news_id, $user_id, $tab_index);
        ...
        if($publish != 'update'){
            if($tab_index==0 || $tab_index==1 || $tab_index==4){
                ...
                $this->dashboard_model->insert_published_news($news_data,$news_id,$team_id,$tab_index,$league_id);
            }elseif($tab_index == 2){
                foreach($publish as $val){
                    $league_id = $val['league_id'];                
                    $news_data = array(
                ...
                $this->dashboard_model->insert_publishedArticle_news($news_data, $tab_index,$league_id);
            }else if($tab_index == 3){
                foreach($publish as $val){
                    $league_id = $val['league_id'];                
                    $news_data = array(                        
        ...
        $contentAry = $this->dashboard_model->getDeviceInfo($newsIdForNotify, $tab_index,$level);      
//echo "Hell44o"; exit;
        ...
        $data['android_res'] = $androidDeviceidAry;
        $data['ios_res'] = $iosDeviceidAry;*/
...
//        exit;
        ...
        $data['ios_res'] = json_decode($ios_res);
    ...
    public function push_fantasy_content($fnews_id){

        $this->dashboard_model->publishfantasynews($fnews_id);
        $this->dashboard_model->notifyfantasynews($fnews_id);
   ...
   // get news row
   public function get_rss_news_detail($news_id,$tab_index){
        $result = $this->dashboard_model->get_rss_news_detail($news_id,$tab_index);
