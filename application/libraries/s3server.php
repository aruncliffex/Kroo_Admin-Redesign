...
{
	// image vars
	private $bucket = 'thekroo-live-storage';
	private $key = 'AKIAILSLP5MHEPGQGKLQ';
	private $secret = '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';
	...
	public function uploadons3($filepath,$thumb_image_name,$upload_dir="newsimages"){
		...
		//return $upload_dir.'/'.$thumb_image_name.'/'.$filepath;
	}
