      ...
      url:url,                    
        ...
        if(getdata !=null){ 
            ...
            $.each(getdata,function(i,row){ 
              ...
              var ans_opt1=row['ans_opt1'];
              var ans_opt2=row['ans_opt2'];
              var ans_opt3=row['ans_opt3'];
              var ans_opt4=row['ans_opt4'];
              var link=row['link'];
              var explaination=row['explaination'];
              var league_id=row['league'];
              var team_id=row['team'];
              var sponser_id=row['sponser'];
              ...
              var  time_to_publish=row['publish_time'];
              var publish_time=parseInt(a)+parseInt(time_to_publish); 
              //var time_to_publish_date=time_to_publishs[0];
              //var time_to_publish_time=time_to_publishs[1];
              ...
              $('#ansTxtOpt1').val(ans_opt1);
              $('#ansTxtOpt2').val(ans_opt2);
              $('#ansTxtOpt3').val(ans_opt3);
              $('#ansTxtOpt4').val(ans_opt4);
              $('#question').val(questions);
              $('#credits').val(credits);
              $('#qusId').val(id);
              $('#explanation_answer').val(explaination);
              $('#linkid').val(link);
              $('input[name="news_img"]').val(game_image);
              $('.thumbnl').attr('src',S3 + 'newsimages/'+game_image);
              $('select[name="news_league_id"] option[value="'+league_id+'"]').attr('selected','selected');
              $('select[name="sponser"] option[value="'+sponser_id+'"]').attr('selected','selected');
              ...
              if(game_type=='1'){
                  $('#myAddModal').find('#difficulty_block').css({'display':'block'});
                  $('#myAddModal').find('select[name="select_difficulty"] option[value="'+difficulty+'"]').attr('selected','selected');  
              }else{
                  $('#myAddModal').find('#difficulty_block').css({'display':'none'});
              }
      ...
      url:url,                    
        ...
        if(getdata !=null){ 
            ...
            $.each(getdata,function(i,row){ 
              ...
              $('input[name="time_to_publish_date"]').val(row['pdate']);
              $('input[name="time_to_publish_time"]').val(row['ptime']);
              $('#ansTxtOpt1View').val(ans_opt1);
              $('#ansTxtOpt2View').val(ans_opt2);
              $('#ansTxtOpt3View').val(ans_opt3);
              $('#ansTxtOpt4View').val(ans_opt4);
              $('#questionView').val(questions);
              $('#creditsView').val(credits);
              $('#explanation_answerView').val(explaination);
              $('#linkidView').val(link);
              ...
              //$('#datepicker').val(time_to_publish_date);
              //$('#datetimepicker3').val(time_to_publish_time);
              if(game_type=='1'){
                  $('#myviewModal').find('#difficulty_block').css({'display':'block'});
                  $('#myviewModal').find('select[name="select_difficulty"] option[value="'+difficulty+'"]').attr('selected','selected');  
              }else{
